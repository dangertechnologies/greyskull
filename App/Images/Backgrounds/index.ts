export default {
  crunches: require('./crunches-blur.jpg'),
  ...
  pullups: require('./pullup-blur.jpg'),
  rest: require('./rest-blur.jpg'),
  squat: require('./squat-blur.jpg'),
  'woman-with-barbell': require('./woman-barbell-blur.jpg'),
};
